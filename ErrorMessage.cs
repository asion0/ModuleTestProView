        ...
        public static void Show(Errors er)
        {
            switch (er)
            {
                ...
                case Errors.CreateFolderFail:
                    ...
                    break;
                case Errors.NoBackupDevice:
                    MessageBox.Show(Program.rm.GetString("NoBackupDevice"), Program.rm.GetString("MessageBoxErrorTitle"), MessageBoxButtons.OK, MessageBoxIcon.Error);
                    break;
                case Errors.InsufficientDiskSpace:
                    MessageBox.Show(Program.rm.GetString("InsufficientDiskSpace"), Program.rm.GetString("MessageBoxErrorTitle"), MessageBoxButtons.OK, MessageBoxIcon.Error);
                    break;
                case Errors.BackupDrivePermissionsDenied:
                    MessageBox.Show(Program.rm.GetString("BackupDrivePermissionsDenied"), Program.rm.GetString("MessageBoxErrorTitle"), MessageBoxButtons.OK, MessageBoxIcon.Error);
                    break;
                case Errors.WriteFailure:
                    MessageBox.Show(Program.rm.GetString("WriteFailure"), Program.rm.GetString("MessageBoxErrorTitle"), MessageBoxButtons.OK, MessageBoxIcon.Error);
                    break;
            }
        }
